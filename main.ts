radio.onReceivedNumberDeprecated(function (receivedNumber) {
    ...
    if (item == 5) {
        maqueen.MotorRun(maqueen.aMotors.M1, maqueen.Dir.CW, 64)
        maqueen.MotorRun(maqueen.aMotors.M2, maqueen.Dir.CW, 64)
    }
    if (item == 6) {
        maqueen.MotorRun(maqueen.aMotors.M1, maqueen.Dir.CCW, 64)
        maqueen.MotorRun(maqueen.aMotors.M2, maqueen.Dir.CCW, 64)
    }
    if (item == 7) {
        maqueen.MotorRun(maqueen.aMotors.M1, maqueen.Dir.CW, 0)
